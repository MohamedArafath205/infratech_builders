      ...
      <main className="text-white">
        <section className="container flex flex-col items-center justify-center py-10 md:h-[500px]">
          <div className="grid grid-cols-1  items-center gap-4 md:grid-cols-2">
            ...
            >
              <h1 className="md:text-5xl text-3xl mx-auto font-bold text-black">{title}</h1>
              <p className="=font-bold  py-4 max-w-[600px]  text-black">
                {description}
                <span className="text-primary">{description2}</span>              </p>
              <div>
                {/* Additional content */}
              </div>
